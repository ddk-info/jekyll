...
$("#js-deposite-neteller-account-id-validation").numeric();
$("#js-deposite-neteller-account-id-validation").keyup(function(){
...
$("#js-deposite-neteller-secure-id-validation").numeric();
$("#js-deposite-neteller-secure-id-validation").keyup(function(){
...
$("#js-deposite-neteller-deposite-amount-validation").numeric()
$("#js-deposite-neteller-deposite-amount-validation").keyup(function(){
  if ($(this).val() == "") {
